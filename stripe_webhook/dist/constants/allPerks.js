...
exports.allPerksDict = exports.allPerks = exports.allDevelopmentPerks = exports.allProductionPerks = void 0;
...
exports.allPerks = process.env.NODE_ENV == "production"
    ? exports.allProductionPerks
    : exports.allDevelopmentPerks;
exports.allPerksDict = exports.allPerks.reduce((map, perk) => ((map[perk.Name] = {
    Cost: perk["Cost"],
    Period: perk["Period"],
    Name: perk.Name,
    Img: perk.Img,
    ...
    map), {});
//# sourceMappingURL=allPerks.js.map