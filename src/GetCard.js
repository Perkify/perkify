                ...
                {success ?
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={12}>
                            ...
                            <BootstrapInput placeholder="johnsmith@mybusiness.com" id="email" variant="outlined"
                        ...
                        <Grid item xs={12} md={4}>
                            ...
                            <BootstrapInput placeholder="John" id="firstName" variant="outlined" style={{width: "100%"}}
                        ...
                        <Grid item xs={12} md={4}>
                            ...
                            <BootstrapInput placeholder="Smith" id="lastName" variant="outlined" style={{width: "100%"}}
                        ...
                        <Grid item xs={12} md={4}>
                            ...
                            <BootstrapInput id="dob" type="date" style={{width: "100%"}}
                        ...
                        <Grid item xs={12} md={12} className={classes.footer}>
                            ...
                            <a href="https://www.getperkify.com/view-my-card" className="sign-in">&nbsp;Sign In</a>
                        </Grid>
                    </Grid>
                }
            </Grid>
