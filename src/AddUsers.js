...
const AddUsers = ({ history }) => {
    ...
    return (
        ...
        <Grid item xs={8} sm={8} style={{height: "650px"}}>
          ...
          alignItems: "left", textAlign: "center"}}> Add Users</h1> 
...
>
<Select style = {{width: "100%", borderRadius: "5px"}} onSelect={getPerksData}>
    {groupData.map(name => <Option value={name}>{name}</Option>)}
    </Select>
</Form.Item>
</Grid> 
<Grid item xs> </Grid>
